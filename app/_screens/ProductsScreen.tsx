      ...
      <form className="modal product-form-modal" onSubmit={saveProduct} onMouseDown={(event) => event.stopPropagation()}>
        ...
        <div className="product-form-scroll">
          <div className="product-form-grid">
            <label>SKU<input value={form.sku} onChange={(event) => updateField("sku", event.target.value.toUpperCase())} placeholder="เช่น CHK-001" required /></label>
            ...
            <label>จำนวนที่รับเข้า<input type="number" min="0" step="0.001" value={form.stockQuantity} onChange={(event) => updateField("stockQuantity", event.target.value)} placeholder="0" required /></label>
